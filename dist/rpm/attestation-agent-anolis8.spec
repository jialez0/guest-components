...
pushd guest-components/dist/tpm-deps/anolis_8
# Extract tpm2-tss RPM package
mkdir -p tpm2-tss-extracted
pushd tpm2-tss-extracted
rpm2cpio ../tpm2-tss-2.4.6-1.an8.x86_64.rpm | cpio -idmv
popd
popd
...
pushd dist/tpm-deps/anolis_8/tpm2-tss-extracted
...
- Integrated tpm2-tss version 2.4.6 from pre-built RPM package for Anolis 8 