...
cargo build -p attestation-agent --bin ttrpc-aa --release --no-default-features --features bin,ttrpc,rust-crypto,coco_as,kbs,tpm-attester,tdx-attester,sgx-attester,instance_info --target x86_64-unknown-linux-gnu
